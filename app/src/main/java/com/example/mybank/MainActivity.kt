    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            val googleClientId = try {
                ...
                Log.e(TAG, "Error getting default_web_client_id string resource", e)
                // Fallback: use empty string if resource not found
                ""
            }

            if (googleClientId.isEmpty()) {
                Log.e(TAG, "WARNING: default_web_client_id is empty - Google Sign-In may not work")
            }
